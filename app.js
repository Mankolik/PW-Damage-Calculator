...
const weapons = [
  ...
  weapon({ name: "Beretta", file: "Beretta.webp", type: "ranged", baseDamage: 114, criticalChance: 5 }),
  ...
  weapon({ name: "Bone Hammer", file: "Bone_Hammer.webp", baseDamage: 111, criticalChance: 4, earth: 11 }),
  weapon({ name: "Broom", file: "Broom.webp", baseDamage: 100, criticalChance: 0, dark: 7 }),
  weapon({ name: "Bunnynator Gun", file: "Bunnynator_Gun.webp", type: "ranged", baseDamage: 120, criticalChance: 2, earth: 5 }),
  ...
  weapon({ name: "Cleaver Sword", file: "Cleaver_Sword.webp", baseDamage: 112, criticalChance: 12 }),
  ...
  weapon({ name: "Flame Glove", file: "Flame_Glove.webp", baseDamage: 100, criticalChance: 5, fire: 20 }),
  weapon({ name: "Flame Sword", file: "Flame_Sword.webp", baseDamage: 18, criticalChance: 0, fire: 228 }),
  weapon({ name: "Galactic Champion Plasma Gun", file: "Galactic_Champion_Plasma_Gun.webp", type: "ranged", baseDamage: 10, criticalChance: 1, dark: 112 }),
  ...
  weapon({ name: "Golden Desert Eagle", file: "Golden_Desert_Eagle.webp", type: "ranged", baseDamage: 128, criticalChance: 2 }),
  ...
  weapon({ name: "Hammer of Summer", file: "Hammer_of_Summer.webp", baseDamage: 120, criticalChance: 7 }),
  ...
  weapon({ name: "Insulting Bat", file: "Insulting_Bat.webp", baseDamage: 125, criticalChance: 3 }),
  weapon({ name: "Katana", file: "Katana.webp", baseDamage: 209, criticalChance: 5 }),
  weapon({ name: "Knight Great Sword", file: "Knight_Great_Sword.webp", baseDamage: 130, criticalChance: 8 }),
  ...
  weapon({ name: "Quickdraw Blades of Nether", file: "Quickdraw_Blades_of_Nether.webp", baseDamage: 116, criticalChance: 3, air: 5, dark: 12 }),
  weapon({ name: "Ray-Gun", file: "Ray-Gun.webp", type: "ranged", baseDamage: 1, criticalChance: 1, fire: 112 }),
  ...
  weapon({ name: "Steel Mace", file: "Steel_Mace.webp", baseDamage: 124, criticalChance: 1 }),
  ...
  weapon({ name: "Thor's Hammer", file: "Thor's_Hammer.webp", type: "ranged", baseDamage: 100, criticalChance: 1, air: 40 }),
  weapon({ name: "Throwable Axe", file: "Throwable_Axe.webp", type: "ranged", baseDamage: 155, criticalChance: 1 }),
  weapon({ name: "Viking Spear", file: "Viking_Spear.webp", baseDamage: 112, criticalChance: 0 }),
